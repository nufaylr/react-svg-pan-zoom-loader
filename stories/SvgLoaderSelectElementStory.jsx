    ...
    return (
      <StrictMode>
        <ReactSvgPanZoomLoader
          src={text(srcLabel, srcDefaultValue)}
          proxy={
            <>
              <SvgLoaderSelectElement
                selector={text(selectorLabel, selectorDefaultValue)}
                onClick={proxyArg.action(`${selectorDefaultValue}`)}
              />
              <SvgLoaderSelectElement
                selector="#tree"
                onClick={proxyArg.action("#tree")}
              />
            </>
          }
          render={content => (
